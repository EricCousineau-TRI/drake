...
class TestCustom(unittest.TestCase):
    ...
    def test_diagram_adder(self):
        ...
        self.assertEqual(system.GetSystemType(), "custom_test.CustomDiagram")
    ...
    def test_adder_execution(self):
        ...
        self.assertEqual(system.GetSystemType(), "custom_test.CustomAdder")
    ...
    def test_vector_system_overrides(self):
        ...
        for is_discrete in [False, True]:
            ...
            self.assertEqual(
                system.GetSystemType(), "custom_test.CustomVectorSystem")
            context = system.CreateDefaultContext()

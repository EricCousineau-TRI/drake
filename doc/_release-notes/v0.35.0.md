...
* Add implemention of Time Optimal Path Parameterization based on Reachability Analysis (TOPPRA) ([#15731][_#15731])
...
* Remove VolumeVertex, SurfaceVertex, and SurfaceVertexIndex ([#15903][_#15903], [#15912][_#15912])
...
* Enable hydroelastic geometry visualization for Meshcat Python ([#15773][_#15773])
...
* pydrake.geometry.SceneGraphInspector.maybe_get_hydroelastic_mesh ([#15773][_#15773])
...
* Overloads using Eigen::Isometry3 for drake::manipulation::planner::DoDifferentialInverseKinematic ([#15909][_#15909])

...
* SystemBase::DeclareCacheEntry is now protected, per announced deprecation
([#15862][_#15862])
* fast_qp and gurobi_qp have been removed ([#15817][_#15817])
    * If you need this functionality, please copy these files into your
    project's source tree.
* Remove VolumeVertex, SurfaceVertex, and SurfaceVertexIndex ([#15903][_#15903],
[#15912][_#15912])
...
* Add implemention of Time Optimal Path Parameterization based on
Reachability Analysis (TOPPRA) ([#15731][_#15731])
* Add additional constraints to Toppra ([#15799][_#15799])
* Add support to Meshcat C++ for texture maps for obj files ([#15788][_#15788])
* Allow visualization of hydroelastic meshes with DrakeVisualizer ([#15772][_#15772])
* Add publish_period option to LCM contact results ([#15848][_#15848])
* Promote MultibodyPlantConfig out of dev ([#15826][_#15826])
...
* Add heap-free variants of MultibodyPlant::GetPositions(ModelInstanceIndex) and
related methods ([#15900][_#15900])

Fixes

* Fix URDF unconditional warnings to be reported only once ([#15783][_#15783])
* Fix segfault for Meshcat C++ on Mac when exiting a binary while a browser is
still connected ([#15823][_#15823])
* Set default visualization publish period to 32 Hz or 64 Hz by default ([#15850]
* Remove VolumeVertex and SurfaceVertex ([#15903][_#15903])
* Remove VolumeVertex, SurfaceVertex, and SurfaceVertexIndex ([#15903][_#15903],
[#15912][_#15912])
...
* Use a smaller time step in Atlas example to avoid discrete solver errors
([#15814][_#15814])
* Fix camera + robot positioning for `rendering_multibody_plant` notebook
([#15841][_#15841])
* Ensure a SceneGraph is connected for contact visualization
([#15849][_#15849])
* Ensure AcrobotPlant::get_mutable_parameters are actually mutable (removes
spurious const) ([#15812][_#15812])

## Miscellaneous features and fixes

<!-- <relnotes for common,math,lcm,lcmtypes,manipulation,perception go here> -->

* Allow `copyable_unique_ptr` to be usable on forward-declared types
([#15906][_#15906])
...
* Add type alias `LinearSolver<>`, rename LinearSolve to SolveLinearSystem
([#15790][_#15790])
* Clean up PiecewisePose and add python bindings ([#15786][_#15786])
* Provide more useful error messages for piecewise polynomial spline generation
([#15795][_#15795])
* Initialize AutoDiffXd::value field to NaN ([#15792][_#15792])
* Enable hydroelastic geometry visualization for Meshcat Python
([#15773][_#15773])
* Add PiecewisePose::MakeLinear ([#15803][_#15803])
* Provide Google Style Guide-compliant spellings for autodiff utility functions;
deprecate old spellings ([#15699][_#15699], [#15875][_#15875])
* Update lcmt_panda_command to be more concise about command mode and which
fields are required vs. ignored ([#15784][_#15784])
* Add LinearSolver class ([#15818][_#15818])
* Replace LDLT in MultibodyPlant with math::LinearSolver for better performance
with AutoDiffScalar ([#15874][_#15874])
* Ensure SortedPair is consistent with the wrapper type's operators
([#15907][_#15907])
* Ensure BsplineTrajectory::EvalDerivative works ([#15895][_#15895])
* Ensure DRAKE_DEFAULT_COPY_AND_MOVE_AND_ASSIGN detects mis-uses
([#15884][_#15884])
...
* Expose `pydrake.common.deprecation.deprecated_callable` as decorator
([#15877][_#15877])
...
* pydrake.geometry.SceneGraphInspector.maybe_get_hydroelastic_mesh
([#15773][_#15773])
* pydrake.autodiffutils.InitializeAutoDiffTuple ([#15699][_#15699]) <!-- Not a
binding per se, but still present in bindings themselves. -->
...
* Add a `-y` flag for Ubuntu `install_prereqs` ([#15819][_#15819])
...
* Overloads using Eigen::Isometry3 for
drake::manipulation::planner::DoDifferentialInverseKinematic
([#15909][_#15909])
...
* drake::systems::SystemBase::DeclareCacheEntry (the non-ValueProducer
overload) ([#15834][_#15834])
([#15863][_#15863])
